...
export ZSH="/home/booltox/.oh-my-zsh"
...
plugins=(adb git taskwarrior tig themes ubuntu z zsh-syntax-highlighting)
...
whoami=$(whoami)
space="             ࿗࿗࿗࿗ "
echo $space$whoami | toilet -f pagga --gay
# fortune
