...
vim.g.netrw_winsize = 25 -- total window width
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'typescript', 'cmake', 'make', 'glsl' },
...
local servers = { 'clangd', 'rust_analyzer', 'pyright', 'sumneko_lua', 'zls', 'neocmake' }
